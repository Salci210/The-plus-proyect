...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Friday Night Funkin' Plus", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Friday Night Funkin' Plus", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "18";
		app.meta["company"] = "fnfplusteam";
		app.meta["file"] = "Friday Night Funkin' Plus";
		app.meta["name"] = "Friday Night Funkin' Plus";
		app.meta["packageName"] = "com.twenty.fnfplus";
		app.meta["version"] = "v0.4.0";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "Friday Night Funkin' Plus",
			width: 0,
			x: null,
			y: null,
		};
