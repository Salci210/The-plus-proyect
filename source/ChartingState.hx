package;
// no le puse botones me da hueva
...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	{
		var instrucciones = new FlxText(0, 0, 0,"Presiona save para guardar en el portapapeles tus charts", 24);
		add(instrucciones);
        instrucciones.x = (FlxG.width / 2) - (instrucciones.width / 2);
        instrucciones.y = FlxG.height - 56;
        instrucciones.alpha = 0.3;
