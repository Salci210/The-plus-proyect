...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'thorns':
				...
				FlxG.sound.music.fadeIn(1, 0, 0.8);
				//Musica de fondo de Xevent solo 
			//case 'tresc':
				//FlxG.sound.playMusic(Paths.music('Redacted'), 0);
				//FlxG.sound.music.fadeIn(1, 0, 0.8);
		}
		...
		portraitgf = new FlxSprite(350, 90);
		portraitgf.frames = Paths.getSparrowAtlas('weeb/gf');
		portraitgf.animation.addByPrefix('enter', 'Girlfriend portrait enter', 24, false);
		portraitgf.setGraphicSize(Std.int(portraitRight.width * 1));
	...
	override function update(elapsed:Float)
	{
		...
		if (PlayerSettings.player1.controls.ACCEPT || screenJustTouched && dialogueStarted == true)
		{
			remove(dialogue);
