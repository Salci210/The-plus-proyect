...
class KadeEngineData
{
    public static function initSave()
    {
		...
		if (FlxG.save.data.lowend == null) // placebo
			FlxG.save.data.lowend = false;

		if (FlxG.save.data.antialiasing == null) // no antialiasing en character
		...
		if (FlxG.save.data.splash == null) // Activa y desactiva el note splash
