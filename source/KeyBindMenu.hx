...
// modified by KadeDev for use in Kade Engine/Trickygdg
...
class KeyBindMenu extends FlxSubState
{
	...
	{	
        ...
        exitButton = new FlxButton(60, 60, "exit", exitButt);
        exitButton.scale.x = exitButton.scale.y = 3;
        exitButton.label.setFormat(null, 32);
        exitButton.label.width *= 3;
        add(exitButton);
