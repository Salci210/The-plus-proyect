...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItems:Array<String> = ['Resume', 'Restart Song', 'debug menu', 'SkipSong', 'Exit to menu'];
	...
	public function new(x:Float, y:Float)
	{
		...
		#if !debug
		menuItems = ['Resume','Restart Song', 'debug menu', 'SkipSong', 'Exit to menu'];
		#end

		//#if debug
		if (PlayState.SONG.song.toLowerCase() == 'ugh' #if debug || true  #end)
					menuItems.push("Actor De Voz");
		//#end

		//#if debug
		if (PlayState.SONG.song.toLowerCase() == 'guns' #if debug || true  #end)
					menuItems.push("Actor De Voz");
		//#end
		//#if debug
				if (PlayState.SONG.song.toLowerCase() == 'stress' #if debug || true  #end)
					menuItems.push("Actor De Voz");
		//#end
