...
class PlayState extends MusicBeatState
{
  ...
  public static var ZardyBackground:FlxSprite;
	...
	// fafafafar better corre empieza a correr ohhhhh otyayayayaya
	var fc:Bool = true;
	...
	override public function create()
	{
		...
		// Rendimiento
		PlayStateChangeables.Antialiasing = FlxG.save.data.antialiasing;
    // modo nigga (optimizacion)
...
//				iconRPC = 'mom';
		...
		switch(songLowercase)
		{
			...
			case 'senpai' | 'roses' | 'thorns' | 'tutorial' | 'bopeebo' | 'fresh' | 'dadbattle':
				if(FlxG.save.data.language){
					dialogue = CoolUtil.coolTextFile(Paths.txt('data/' + songLowercase + '/ESP'));
				}
				else{
					dialogue = CoolUtil.coolTextFile(Paths.txt('data/' + songLowercase + '/dialogue'));
				}
			/*case 'parish' | 'worship' | 'zavodila' | 'casanova':
				if(FlxG.save.data.language){
					dialogue2 = CoolUtil.coolTextFile(Paths.txt('data/' + songLowercase + '/ESP2'));
				}
				else{
					dialogue2 = CoolUtil.coolTextFile(Paths.txt('data/' + songLowercase + '/dialogue2'));
				}*/
		}
		...
		switch(SONG.stage)
		{
			case 'halloween': 
			{
				...
				if (!PlayStateChangeables.Antialiasing)
					...
					else if (PlayStateChangeables.Antialiasing)
						{
			...
			case 'stage':
				...
				case 'war':  // ulala señor frances con su carpetita y toda la cosa
				{
				curStage = 'war';
				defaultCamZoom = 0.9;
		...
		case 'warb': 
				...
				tank5.updateHitbox();
					...
					{
							defaultCamZoom = 0.9;
							curStage = 'background-a';
							var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('customweek/background_a'));
							bg.antialiasing = false;
							bg.scrollFactor.set(0.9, 0.9);
							bg.active = false;
							add(bg);
					...
					{
							defaultCamZoom = 0.9;
							curStage = 'background-b';
							var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('customweek/background_b'));
							bg.antialiasing = false;
							bg.scrollFactor.set(0.9, 0.9);
							bg.active = false;
							add(bg);
			...
			case 'alley':
				{
						defaultCamZoom = 0.9;
						curStage = 'alley';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('alley'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		case 'ballisticAlley':
				{
					...
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('ballistic_alley'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
			...
			case 'facility':
				{
						defaultCamZoom = 0.9;
						curStage = 'facility';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('facility'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
...
/* stages antiguos de midfight masses
		case 'churchParish':
				{
						defaultCamZoom = 0.9;
						curStage = 'churchParish';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('church_parish'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		case 'churchWorship':
				{
						defaultCamZoom = 0.9;
						curStage = 'churchWorship';
					var churchWorship:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('church_worship'));
					churchWorship.antialiasing = true;
					churchWorship.scrollFactor.set(0.9, 0.9);
					churchWorship.active = false;
					add(churchWorship);
			}
		...
		case 'churchZavodila':
				{
					...
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('church_zavodila'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		case 'churchGospel':
				{
					...
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('church_gospel'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		case 'churchCasanova':
				{
						defaultCamZoom = 0.9;
						curStage = 'churchCasanova';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('church_casanova'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
...
*/
			...
			case 'churchWorship':
			{
				defaultCamZoom = 0.9;
				curStage = 'churchWorship';
				var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('church_worship'));
				bg.antialiasing = true;
				bg.scrollFactor.set(0.9, 0.9);
				bg.active = false;
				add(bg);
		...
		case 'maze':
				{
						defaultCamZoom = 0.9;
						curStage = 'maze';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('maze'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
...
*/ //outdated LMAO!
		...
		case 'maze':
        {
						defaultCamZoom = 0.9;
						curStage = 'maze';
          var ZardyBackground:FlxSprite = new FlxSprite(-600, -200);
		...
		case 'concert':
				{
						defaultCamZoom = 0.9;
						curStage = 'concert';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('concert'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		case 'arena':
				{
						defaultCamZoom = 0.9;
						curStage = 'arena';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('arena'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		case 'boxingRing':
				{
						defaultCamZoom = 0.9;
						curStage = 'boxingRing';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('boxing_ring'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		case 'boxingArena':
				{
						defaultCamZoom = 0.9;
						curStage = 'boxingArena';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('boxing_arena'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		case 'blackArena':
				{
						defaultCamZoom = 0.9;
						curStage = 'blackArena';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('black_arena'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
			...
			case 'troll':
				{
						defaultCamZoom = 0.9;
						curStage = 'troll';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('troll'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		case 'shzone':
				{
						defaultCamZoom = 0.9;
						curStage = 'shzone';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('shzone'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		case 'volcano':
				{
						defaultCamZoom = 0.9;
						curStage = 'volcano';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('volcano'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
			...
			case 'shiftNormal':
				{
					var tex = Paths.getSparrowAtlas("sky/bga/bg1");
					var tex2 = Paths.getSparrowAtlas("sky/bga/bg2");
					var tex3 = Paths.getSparrowAtlas("sky/bga/bg3");
					...
					shiftbg.frames = tex;
					shiftbg.animation.addByIndices("idle", "bg2",[0, 1, 2, 3, 4, 5, 6, 7],"", 24, false);
				...
				case 'shiftAnnoyed':
				{
					var tex = Paths.getSparrowAtlas("sky/bgn/bgn1");
					var tex2 = Paths.getSparrowAtlas("sky/bgn/bgn2");
					var tex3 = Paths.getSparrowAtlas("sky/bgn/bgn3");
					...
					shiftbg = new FlxSprite( -388.05, -232);
					shiftbg.frames = tex;
					shiftbg.animation.addByIndices("idle", "bg",[0, 1, 2, 3, 4, 5, 6, 7],"", 24, false);
...
/* este codigo es viejo y esta estatico nimodo
	case 'shiftManifest':
				{
						defaultCamZoom = 0.9;
						curStage = 'shiftManifest';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('shift_manifest'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
...
//que paja que peppy ande zzz :"v
			case 'shiftManifest':
			{
					...
					curStage = 'shiftManifest';
					shiftbg = new FlxSprite( -388.05, -232);
					shiftbg.frames = Paths.getSparrowAtlas('sky/bg_manifest', 'shared');
					...
					floor.frames = Paths.getSparrowAtlas('sky/floorManifest', 'shared');
	...
	case 'arcadeWocky':
				{
						defaultCamZoom = 0.9;
						curStage = 'arcadeWocky';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('arcade_wocky'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
	...
	case 'arcadeBeathoven':
				{
						defaultCamZoom = 0.9;
						curStage = 'arcadeBeathoven';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('arcade_beathoven'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
	...
	case 'arcadeHairball':
				{
						defaultCamZoom = 0.9;
						curStage = 'arcadeHairball';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('arcade_hairball'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
	...
	case 'arcadeNyaw':
				{
						defaultCamZoom = 0.9;
						curStage = 'arcadeNyaw';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('arcade_nyaw'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
	...
	case 'flatzone':
				{
						defaultCamZoom = 0.9;
						curStage = 'flatzone';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('flatzone'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
	...
	case 'sewer':
				{
						defaultCamZoom = 0.9;
						curStage = 'sewer';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('sewer'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
	...
	case 'stare':
				{
						defaultCamZoom = 0.9;
						curStage = 'stare';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stare'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		case 'void':
			{
				...
				void.frames = Paths.getSparrowAtlas('agoti/The_void', 'shared');
				...
				bgRocks = new FlxSprite(-1000, -700).loadGraphic(Paths.image('agoti/Void_Back', 'shared'));
				bgRocks.setGraphicSize(Std.int(bgRocks.width * 0.5));
				bgRocks.antialiasing = true;
				bgRocks.scrollFactor.set(0.7, 0.7);
				add(bgRocks);

				var frontRocks:FlxSprite = new FlxSprite(-1000, -600).loadGraphic(Paths.image('agoti/Void_Front', 'shared'));
			...
			case 'pillars':
			{
				...
				bgpillar.frames = Paths.getSparrowAtlas('agoti/Pillar_BG_Stage', 'shared');
				...
				speaker.frames = Paths.getSparrowAtlas('agoti/LoudSpeaker_Moving', 'shared');
      ...
      case 'garAlley':
      {
		  defaultCamZoom = 0.9;
			curStage = 'garAlley';
						  ...
						  var bg:FlxSprite = new FlxSprite(-500, -170).loadGraphic(Paths.image('garcello/garStagebg', 'shared'));
						  bg.antialiasing = true;
						  bg.scrollFactor.set(0.7, 0.7);
						  bg.active = false;
						  add(bg);

						  var bgAlley:FlxSprite = new FlxSprite(-500, -200).loadGraphic(Paths.image('garcello/garStage', 'shared'));
...
//release
		          case 'garAlleyDead':
		          {
						  ...
						  var bg:FlxSprite = new FlxSprite(-500, -170).loadGraphic(Paths.image('garcello/garStagebgAlt', 'shared'));
						  bg.antialiasing = true;
						  bg.scrollFactor.set(0.7, 0.7);
						  bg.active = false;
						  add(bg);
						  ...
						  smoker.frames = Paths.getSparrowAtlas('garcello/garSmoke', 'shared');
						  ...
						  var bgAlley:FlxSprite = new FlxSprite(-500, -200).loadGraphic(Paths.image('garcello/garStagealt', 'shared'));
						  bgAlley.antialiasing = true;
						  bgAlley.scrollFactor.set(0.9, 0.9);
						  bgAlley.active = false;
						  add(bgAlley);

						  var corpse:FlxSprite = new FlxSprite(-230, 540).loadGraphic(Paths.image('garcello/gardead', 'shared'));
...
//fading
		          case 'garAlleyDip':
		          {
						  ...
						  var bg:FlxSprite = new FlxSprite(-500, -170).loadGraphic(Paths.image('garcello/garStagebgRise', 'shared'));
						  bg.antialiasing = true;
						  bg.scrollFactor.set(0.7, 0.7);
						  bg.active = false;
						  add(bg);

						  var bgAlley:FlxSprite = new FlxSprite(-500, -200).loadGraphic(Paths.image('garcello/garStageRise', 'shared'));
						  bgAlley.antialiasing = true;
						  bgAlley.scrollFactor.set(0.9, 0.9);
						  bgAlley.active = false;
						  add(bgAlley);
...
//POSICION DE LA WEA DE LOS PERSONAJES DIOS
			case "spooky":
				dad.y += 200;
			case "tankman":
				dad.y += 180;
...
/* saving dis for 2 things
1. add zardy pt 2
2. gf alpha cuz i have bad memory 
(gf alpha 0 is to disappear the gf shit)
					case 'zardyBruh':
						boyfriend.y += 130;
						boyfriend.x += 40;
						gf.alpha = 0;
*/
		...
		{
//la barra de vida de los payasitos del circo jajtlvlk4mcnrmfm dia del payacho
		case 'bf':
   ...
   healthBar.createFilledBar(0xFFF3FF6E, 0xFF31B0D1);
			case 'test':
   healthBar.createFilledBar(0xFFA1A1A1, 0xFF31B0D1);
			case 'senpai':
   ...
   healthBar.createFilledBar(0xFFFF3C6E, 0xFF31B0D1);
			case 'tankman':
   healthBar.createFilledBar(0xFFF7BD01, 0xFF31B0D1);
			case 'whitty':
   healthBar.createFilledBar(0xFF1D1E35, 0xFF31B0D1);
			case 'whitty-ballistic':
   healthBar.createFilledBar(0xFFCE002C, 0xFF31B0D1);
			case 'updike':
   healthBar.createFilledBar(0xFFE1E1E1, 0xFF31B0D1);
			case 'sarvente':
   ...
   healthBar.createFilledBar(0xFFDA317D, 0xFF31B0D1);
			case 'selever':
   healthBar.createFilledBar(0xFF972651, 0xFF31B0D1);
			case 'zardy':
   healthBar.createFilledBar(0xFFBA7B41, 0xFF31B0D1);
			case 'matt':
   healthBar.createFilledBar(0xFFFF8B00, 0xFF31B0D1);
			case 'matt-angry':
   healthBar.createFilledBar(0xFFFF8B00, 0xFF31B0D1);
			case 'matt-boxing':
   healthBar.createFilledBar(0xFFFF8B00, 0xFF31B0D1);
   ...
   healthBar.createFilledBar(0xFFFF8B00, 0xFF31B0D1);
			case 'miku':
   healthBar.createFilledBar(0xFF32CDCC, 0xFF31B0D1);
			case 'miku-mad':
   healthBar.createFilledBar(0xFF3EFFFE, 0xFF31B0D1);
			case 'carol':
   healthBar.createFilledBar(0xFF666699, 0xFF31B0D1);
			case 'carol-angel':
   healthBar.createFilledBar(0xFFFF9400, 0xFF31B0D1);
			case 'sky':
   healthBar.createFilledBar(0xFF9C6ECC, 0xFF31B0D1);
			case 'sky-annoyed':
   healthBar.createFilledBar(0xFF9C6ECC, 0xFF31B0D1);
			case 'sky-manifest':
   healthBar.createFilledBar(0xFFBF0000, 0xFF31B0D1);
			case 'kapi':
   healthBar.createFilledBar(0xFF625E84, 0xFF31B0D1);
			case 'kapi-angry':
   healthBar.createFilledBar(0xFF625E84, 0xFF31B0D1);
			case 'mr-game-and-watch':
   healthBar.createFilledBar(0xFF3E3D42, 0xFF31B0D1);
			case 'kris':
   healthBar.createFilledBar(0xFFC9168F, 0xFF31B0D1);
			case 'starecrown':
   healthBar.createFilledBar(0xFF756583, 0xFF31B0D1);
			case 'staredown':
   healthBar.createFilledBar(0xFF55158D, 0xFF31B0D1);
			case 'character-a':
   healthBar.createFilledBar(0xFFA1A1A1, 0xFF31B0D1);
			case 'character-b':
   healthBar.createFilledBar(0xFFA1A1A1, 0xFF31B0D1);
   ...
   healthBar.createFilledBar(0xFF00FF90, 0xFF31B0D1);
			case 'garcellodead':
   healthBar.createFilledBar(0xFFFCFCFC, 0xFF31B0D1);
			case 'garcelloghosty':
   healthBar.createFilledBar(0xFFFCFCFC, 0xFF31B0D1);
		}
		add(healthBar);
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + (Main.watermarks ? " - FNF Plus" + MainMenuState.kadeEngineVer : " 0.4 "), 16);
  ...
  //imagine robbing the modpack lmao
		var creditTxt:FlxText = new FlxText(5, 5, ("@fnf.plus on tiktok"), 20);
		...
		if (isStoryMode)
		{
			switch (StringTools.replace(curSong," ", "-").toLowerCase())
			{
				...
				case 'senpai' #if debug | 'tutorial' | 'bopeebo' | 'fresh' | 'dadbattle' #end: // al rato 
					schoolIntro(doof);
				case 'roses':
			...
			if (FlxG.save.data.cutscene)
				{
					...
					{
			if(FlxG.save.data.language){
					var video = new VideoPlayer(0, 0, 'videos/es/ughcutscene.webm');
			...
			if (FlxG.save.data.cutscene)
				{
					...
					{
			if(FlxG.save.data.language){
					var video = new VideoPlayer(0, 0, 'videos/es/gunscutscene.webm');
					video.finishCallback = () -> {
						remove(video);
						startCountdown();
					}
			...
			if (FlxG.save.data.cutscene)
				{
					...
					{
			if(FlxG.save.data.language){
					var video = new VideoPlayer(0, 0, 'videos/es/stresscutscene.webm');
					video.finishCallback = () -> {
						remove(video);
						startCountdown();
					}
	...
	override public function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.ENTER #if android || FlxG.android.justReleased.BACK #end && startedCountdown && canPause)
		{
			...
			// 1 / 1000 chance for Gitaroo Man easter egg // GITARO MIERDA NO CONFIGURADA POR AHORA LO DEJARE EN 0.0 
		...
		{
			#if windows
			DiscordClient.changePresence("In the Debug Menu", null, null, true);
			#end
			...
			else
			{
				if (isStoryMode)
				{
					...
					if (storyPlaylist.length <= 0)
					{
						...
						if(curSong == "Tutorial" || curSong == "Bopeebo" || curSong == "Fresh" || curSong == "Dad-Battle" || curSong == "Spookeez" || curSong == "Monster" || curSong == "South" || curSong == "Pico" || curSong == "Philly-Nice" || curSong == "Blammed" || curSong == "Satin-Panties" || curSong == "High" || curSong == "Milf" || curSong == "Cocoa" || curSong == "Eggnog" || curSong == "Winter-Horrorland" || curSong == "Senpai" || curSong == "Roses" || curSong == "Thorns" || curSong == "Ugh"|| curSong == "Guns"|| curSong == "Stress")
							{
								FlxG.switchState(new StoryMenuState());	
							}
							else
								{
									FlxG.switchState(new mod.StoryMod());
								}
						#if windows
						if (luaModchart != null)
						{
...
//unavida la puta madre GRRRRRR
					...
					if(curSong == "Tutorial" || curSong == "Bopeebo" || curSong == "Fresh" || curSong == "Dad-Battle" || curSong == "Spookeez" || curSong == "Monster" || curSong == "South" || curSong == "Pico" || curSong == "Philly-Nice" || curSong == "Blammed" || curSong == "Satin-Panties" || curSong == "High" || curSong == "Milf" || curSong == "Cocoa" || curSong == "Eggnog" || curSong == "Winter-Horrorland" || curSong == "Senpai" || curSong == "Roses" || curSong == "Thorns" || curSong == "Ugh"|| curSong == "Guns"|| curSong == "Stress")
						{
							...
							FlxG.switchState(new mod.FreeMod());
				}
			}
		}
	...
	*/
		...
		if (dad.curCharacter == 'tankman' && SONG.song.toLowerCase() == 'stress')
			{
				if (curStep == 735)
				{
					...
					dad.animation.getByName('singDOWN').frames = dad.animation.getByName('good').frames;
	...
	override function beatHit()
	{
		...
		if (curBeat % 2 == 0 && curSong == 'Sky')
		{
			shiftbg.animation.play("bop", true);
		}

		if (curBeat % 2 == 0 && curSong == 'Wife-Forever')
		{
			shiftbg.animation.play("bop", true);
		}
		...
		if (dad.curCharacter == 'garcellodead' && curSong == 'release')
		{
			if (curStep == 838)
			{
		...
		if (dad.curCharacter == 'garcelloghosty' && curSong == 'fading')
		{
			if (curStep == 247)
			{
...
/*
		if (curStep != lastStep && Stage.curStage == "maze")
     {
				switch(curStep)
				{
					case 2426:
