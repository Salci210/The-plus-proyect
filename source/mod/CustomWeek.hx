...
class CustomWeek extends MusicBeatState
{
	...
	var menuItems:Array<String> = ['Story-Mode', 'Freeplay', 'Random-Sound-Effect', 'Donate-The-Original-Creators'];
	...
	{
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('modBG'));
		bg.scrollFactor.x = 0;
	...
	override function update(elapsed:Float)
	{
		...
		if (controls.ACCEPT)
		{
         ...
         var numSound:Int = FlxG.random.int(0, 7);
					FlxG.sound.play(Paths.sound('SoundEffect' + numSound), 1, false, null, true);

				case "Donate-The-Funkin-Team":
