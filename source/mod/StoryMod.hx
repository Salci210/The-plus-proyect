...
class StoryMod extends MusicBeatState
{
	...
	public static var weekUnlocked:Array<Bool> = [true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true];
	...
	var weekNames:Array<String> = [
		...
		"the true finale",
		"the art of war",
		"concert conundrum ft ev and genox",
		"carol",
		"hellchart carol",
  ...
  public static var weekColors:Array<FlxColor> = [
		...
		0xFF3EFFFE, //miku
		0xFF666699, //carol
		0xFFFF9400, //carol hellroll
		0xFF9C6ECC, //sky
		0xFF76719E, //kapi
		0xFFC9168F, //kris
		0xFF756583, //starecrown 1
		0xFF55158D,  //starecrown 2
		0xFFBA1E24,  //agoti
    0xFF00FF90   //garcello
	];
	...
	var grpWeekText:FlxTypedGroup<WeekCON>;
	...
	override function create()
	{
		...
		DiscordClient.changePresence("In the Story Menu (Mods)", null);
		#end
		...
		grpWeekText = new FlxTypedGroup<WeekCON>();
		add(grpWeekText);
		...
		{
			var weekThing:WeekCON = new WeekCON(0, yellowBG.y + yellowBG.height + 10, i);
		...
		txtTracklist.color = 0xFFFFFFF; // 0xFFFF009D
		add(txtTracklist);
		// add(rankText);
		add(scoreText);
		add(txtWeekTitle);
